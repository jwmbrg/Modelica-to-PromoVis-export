...
class ModelicaObject:
    ...
    """
    def __init__(self,jmu,fmu,fmux):
        self.jmu=jmu;
        self.fmu=fmu;
        self.fmux=fmux;
        self.linJmu=None;
    ...
    def getLinearDaeFromJmu(self):
        ...
        self.linJmu={"E":E_dae,"A":A_dae,"B":B_dae,"F":F_dae,"g":g_dae,"State_names":state_names,\
        "input_names":input_names,"algebraic_names":algebraic_names,"dx0":dx0,"x0":x0,"u0":u0,"w0":w0,"t0":t0}
