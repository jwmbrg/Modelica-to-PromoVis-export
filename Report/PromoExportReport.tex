...
\def\thesistitle{Using Modelica models in ProMoVis}
...
\makeappendix{Appendix A}{Solving DAE-system in correct order\label{appA}}
\input{Appendices/appendixA.tex}
\makeappendix{Appendix B}{Why the tool is based on the DAE\label{appB}}
